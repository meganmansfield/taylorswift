...
print('''
    ...
    ''')
trel1=input('Please enter a number from 1 to 7: ')
if not isinstance(trel1,int):
	assert isinstance(trel1,int), "You must enter an integer between 1 and 7"
elif trel1<1:
...
''')
trel2=input('Please enter a number from 1 to 7: ')
if not isinstance(trel2,int):
	assert isinstance(trel2,int), "You must enter an integer between 1 and 7"
elif trel2<1:
...
''')
trel3=input('Please enter a number from 1 to 7: ')
if not isinstance(trel3,int):
	assert isinstance(trel3,int), "You must enter an integer between 1 and 7"
elif trel3<1:
...
''')
trel4=input('Please enter a number from 1 to 7: ')
if not isinstance(trel4,int):
	assert isinstance(trel4,int), "You must enter an integer between 1 and 7"
elif trel4<1:
...
''')
thap1=input('Please enter a number from 1 to 7: ')
if not isinstance(thap1,int):
	assert isinstance(thap1,int), "You must enter an integer between 1 and 7"
elif thap1<1:
...
''')
thap3=input('Please enter a number from 1 to 7: ')
if not isinstance(thap3,int):
	assert isinstance(thap3,int), "You must enter an integer between 1 and 7"
elif thap3<1:
